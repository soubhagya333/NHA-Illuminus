...
class __TwigTemplate_305695d005c3b4fb919e5077c4fdd1392b4e3d215d728a2a225daf68cc0c274d extends \Twig\Template
{
    ...
    public function block_iboPopoverMenuItem($context, array $blocks = [])
    {
        ...
        echo "\" onclick=\"";
        echo twig_escape_filter($this->env, $this->getAttribute(($context["oUIBlock"] ?? null), "GetJsCode", [], "method"));
        echo "\"
            ";
        // line 5
...
";
    ...
    {
        return new Source("", "base/components/popover-menu/item/mode_js.html.twig", "/var/www/html/itop-web/templates/base/components/popover-menu/item/mode_js.html.twig");
    }
}
