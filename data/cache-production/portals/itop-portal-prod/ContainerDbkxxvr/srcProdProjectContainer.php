        ...
        return [
            ...
            'combodo.portal.instance.conf' => [
                'properties' => [
                    ...
                    'logo' => 'http://localhost/itop-web/images/nha-logo.png?t=1669103062.79',
                    'themes' => [
                        'bootstrap' => 'http://localhost/itop-web/env-production/itop-portal-base/portal/public/css/bootstrap-theme-combodo.css',
                        'portal' => 'http://localhost/itop-web/env-production/itop-portal-base/portal/public/css/portal.css',
                        'others' => [
                ...
                'forms' => [
                    ...
                    'Incident' => [
                        'apply_stimulus' => [
                            ...
                            'ev_dispatch' => [
                                '_brought_by' => 'Ticket',
                                'id' => 'apply_stimulus-Incident-ev_dispatch',
                                'type' => 'custom_list',
                                'properties' => [
                                    'display_mode' => 'cosy',
                                    'always_show_submit' => false,
                    ...
                    'UserRequest' => [
                        'apply_stimulus' => [
                            ...
                            'ev_dispatch' => [
                                '_brought_by' => 'Ticket',
                                'id' => 'apply_stimulus-UserRequest-ev_dispatch',
                                'type' => 'custom_list',
                                'properties' => [
                                    'display_mode' => 'cosy',
                                    'always_show_submit' => false,
