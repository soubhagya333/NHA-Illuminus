<?php
//
// File generated on 2022-11-22T13:14:28+0530
...
MetaModel::IncludeModule(MODULESROOT.'/combodo-gantt-view/src/Dashlet/Gantt.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-gantt-view/src/Dashlet/GanttParentFields.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-gantt-view/src/Dashlet/GanttDashlet.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-gantt-view/src/Controller/AbstractGanttViewController.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-gantt-view/src/Controller/AjaxGanttViewController.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-gantt-view/src/Controller/GanttViewController.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-gantt-view/src/Hook/GanttUiExtension.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-workflow-graphical-view/vendor/autoload.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-workflow-graphical-view/src/Hook/ConsoleUIExtension.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-workflow-graphical-view/src/Hook/PortalUIExtension.php');
...
MetaModel::IncludeModule(MODULESROOT.'/combodo-dispatch-incident/model.combodo-dispatch-incident.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-dispatch-userrequest/model.combodo-dispatch-userrequest.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-saml/model.combodo-saml.php');
MetaModel::IncludeModule(MODULESROOT.'/combodo-saml/main.php');
...
return array (
  ...
  'combodo-gantt-view' => 
  array (
    'root_dir' => $sCurrEnv.'/combodo-gantt-view',
    'version' => '1.1.1',
  ),
  'combodo-workflow-graphical-view' => 
  array (
    'root_dir' => $sCurrEnv.'/combodo-workflow-graphical-view',
    'version' => '1.1.0',
  ),
  'itop-attachments' => 
  array (
  ...
  'sample-portal-add-button' => 
  array (
    'root_dir' => $sCurrEnv.'/sample-portal-add-button',
    'version' => '1.0.0',
  ),
  'combodo-db-tools' => 
  array (
  ...
  array (
    'root_dir' => $sCurrEnv.'/combodo-dispatch-incident',
    'version' => '1.1.9',
  ),
  'combodo-dispatch-userrequest' => 
  array (
    'root_dir' => $sCurrEnv.'/combodo-dispatch-userrequest',
    'version' => '1.1.11',
  ),
  'combodo-saml' => 
  array (
    'root_dir' => $sCurrEnv.'/combodo-saml',
    'version' => '1.1.1',
  ),
