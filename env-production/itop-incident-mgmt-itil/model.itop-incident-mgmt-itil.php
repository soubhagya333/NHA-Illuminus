...
class Incident extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("origin", array("allowed_values"=>new ValueSetEnum("mail,phone,portal,chat boat,monitoring"), "display_style"=>'list', "sql"=>'origin', "default_value"=>'phone', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeStopWatch("tto", array("states"=>array("new", "escalated_tto", "dispatched"), "goal_computing"=>'ResponseTicketTTO', "working_time_computing"=>'', "thresholds"=>array(75 => array('percent' => 75, 'highlight' => array('code' => 'warning', 'persistent' => false),  'actions' => array()), 100 => array('percent' => 100, 'highlight' => array('code' => 'critical', 'persistent' => false),  'actions' => array(array('verb' => 'ApplyStimulus', 'params' => array(array('type' => 'string', 'value' => "ev_timeout")))))), "always_load_in_tables"=>true)));
		MetaModel::Init_AddAttribute(new AttributeStopWatch("ttr", array("states"=>array("new", "escalated_tto", "assigned", "escalated_ttr", "dispatched", "redispatched"), "goal_computing"=>'ResponseTicketTTR', "working_time_computing"=>'', "thresholds"=>array(75 => array('percent' => 75, 'highlight' => array('code' => 'warning', 'persistent' => false),  'actions' => array()), 100 => array('percent' => 100, 'highlight' => array('code' => 'critical', 'persistent' => false),  'actions' => array(array('verb' => 'ApplyStimulus', 'params' => array(array('type' => 'string', 'value' => "ev_timeout")))))), "always_load_in_tables"=>true)));
		...
		MetaModel::Init_DefineStimulus(new StimulusUserAction("ev_dispatch", array()));
		...
		MetaModel::Init_DefineTransition("new", "ev_dispatch", array(
		...
		MetaModel::Init_DefineTransition("assigned", "ev_dispatch", array(
            "target_state"=>"redispatched",
            "actions"=>array(array('verb' => 'Reset', 'params' => array(array('type' => 'string', 'value' => "agent_id")))),
            "user_restriction"=>null,
            "attribute_list"=>array(
            )
        ));
		...
		MetaModel::Init_DefineTransition("escalated_ttr", "ev_dispatch", array(
            "target_state"=>"redispatched",
            "actions"=>array(array('verb' => 'Reset', 'params' => array(array('type' => 'string', 'value' => "agent_id")))),
            "user_restriction"=>null,
            "attribute_list"=>array(
		...
		MetaModel::Init_DefineTransition("dispatched", "ev_assign", array(
            "target_state"=>"assigned",
            "actions"=>array(array('verb' => 'SetCurrentDate', 'params' => array(array('type' => 'string', 'value' => "assignment_date")))),
            "user_restriction"=>null,
            "attribute_list"=>array(
            )
        ));
		MetaModel::Init_DefineTransition("dispatched", "ev_timeout", array(
            "target_state"=>"escalated_tto",
            "actions"=>array(),
            "user_restriction"=>null,
            "attribute_list"=>array(
		...
		MetaModel::Init_DefineTransition("dispatched", "ev_autoresolve", array(
            "target_state"=>"resolved",
            "actions"=>array(array('verb' => 'SetCurrentDate', 'params' => array(array('type' => 'string', 'value' => "resolution_date"))), array('verb' => 'SetElapsedTime', 'params' => array(array('type' => 'string', 'value' => "time_spent"), array('type' => 'string', 'value' => "start_date"), array('type' => 'string', 'value' => "DefaultWorkingTimeComputer"))), array('verb' => 'ResolveChildTickets', 'params' => array())),
            "user_restriction"=>null,
            "attribute_list"=>array(
            )
        ));
		...
		MetaModel::Init_DefineTransition("redispatched", "ev_assign", array(
            "target_state"=>"assigned",
            "actions"=>array(),
            "user_restriction"=>null,
            "attribute_list"=>array(
		...
		MetaModel::Init_DefineTransition("redispatched", "ev_timeout", array(
            "target_state"=>"escalated_ttr",
            "actions"=>array(),
            "user_restriction"=>null,
            "attribute_list"=>array(
		...
		MetaModel::Init_DefineTransition("redispatched", "ev_autoresolve", array(
            "target_state"=>"resolved",
            "actions"=>array(array('verb' => 'SetCurrentDate', 'params' => array(array('type' => 'string', 'value' => "resolution_date"))), array('verb' => 'SetElapsedTime', 'params' => array(array('type' => 'string', 'value' => "time_spent"), array('type' => 'string', 'value' => "start_date"), array('type' => 'string', 'value' => "DefaultWorkingTimeComputer"))), array('verb' => 'ResolveChildTickets', 'params' => array())),
            "user_restriction"=>null,
            "attribute_list"=>array(
...
public function DoCheckToWrite()
  {
	 ...
	 */
	public function ResetAgent($sStimulusCode)
	{
		$this->Set('agent_id', 0);
		return true;
	}
