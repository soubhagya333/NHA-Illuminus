...
class UserRequest extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("origin", array("allowed_values"=>new ValueSetEnum("mail,phone,portal,chat boat"), "display_style"=>'list', "sql"=>'origin', "default_value"=>'phone', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeStopWatch("tto", array("states"=>array("new", "escalated_tto", "approved", "dispatched"), "goal_computing"=>'ResponseTicketTTO', "working_time_computing"=>'', "thresholds"=>array(75 => array('percent' => 75, 'highlight' => array('code' => 'warning', 'persistent' => false),  'actions' => array()), 100 => array('percent' => 100, 'highlight' => array('code' => 'critical', 'persistent' => false),  'actions' => array(array('verb' => 'ApplyStimulus', 'params' => array(array('type' => 'string', 'value' => "ev_timeout")))))), "always_load_in_tables"=>true)));
		MetaModel::Init_AddAttribute(new AttributeStopWatch("ttr", array("states"=>array("new", "escalated_tto", "assigned", "approved", "escalated_ttr", "dispatched", "redispatched"), "goal_computing"=>'ResponseTicketTTR', "working_time_computing"=>'', "thresholds"=>array(75 => array('percent' => 75, 'highlight' => array('code' => 'warning', 'persistent' => false),  'actions' => array()), 100 => array('percent' => 100, 'highlight' => array('code' => 'critical', 'persistent' => false),  'actions' => array(array('verb' => 'ApplyStimulus', 'params' => array(array('type' => 'string', 'value' => "ev_timeout")))))), "always_load_in_tables"=>true)));
		...
		MetaModel::Init_DefineTransition("approved", "ev_dispatch", array(
            "target_state"=>"dispatched",
            "actions"=>array(),
            "user_restriction"=>null,
            "attribute_list"=>array(
